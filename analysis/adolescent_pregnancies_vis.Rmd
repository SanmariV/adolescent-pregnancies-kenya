...
output: 
  flexdashboard::flex_dashboard:
    ...
    source_code: https://github.com/SanmariV/teenage-pregnancies-in-kenya
    social: menu
runtime: shiny
...
```{r include=FALSE}
init_data <- read_csv("/Users/susanroets/Dropbox/Personal/R programming/teenage_pegnancies_kenya/teenage-pregnancies-kenya/analysis/Teenage Pregnancies Data 2016 to 2020_WardLevel_Quarterly.csv")
...
use_this_style <- function(){
  ...
  ggplot2::theme(plot.title = ggplot2::element_text(family = font, 
                 ...
                 axis.text = ggplot2::element_text(family = font, size = 7, 
...
detail_data <- detail_data %>% 
  rename(county = orgunitlevel2, sub_county = orgunitlevel3,
         ward = orgunitlevel4, age_10_to_14 = `adolescents (10-14 years) with  pregnancy`,
         age_15_to_19 = `adolescents (15-19 years) with  pregnancy`) %>% 
  replace_na(list(age_10_to_14 = 0, age_15_to_19 = 0))
...
detail_data_2 <- detail_data_2 %>% 
  mutate(total = age_10_to_14 + age_15_to_19)
...
detail_data_3 <- detail_data_2 %>% 
  select(county, sub_county, ward, age_10_to_14, age_15_to_19, Year_quarter)
